...
def answer_support(question, k=3):
    ...
    results = supabase.rpc(
        "match_documents_helpdesk",  # ta fonction SQL de recherche vectorielle
        {
    ...
    prompt = f"""Tu es un assistant Helpdesk. Réponds clairement et efficacement aux questions techniques des utilisateurs, en fournissant des solutions simples et pratiques.
