...
def answer_sales(question, k=3):
    ...
    results = supabase.rpc(
        "match_documents_sales",  # ta fonction SQL de recherche vectorielle
        {
    ...
    prompt = f"""Tu es un assistant commercial. Aide le client à découvrir les offres du cabinet et à les convaincre :
{context}
