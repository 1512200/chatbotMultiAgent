...
PDF_DIR = "../vector_store/docs/tutoring_docs"
IMAGE_DIR = "../vector_store/docs/tutoring_docs/images"
VIDEO_DIR = "../vector_store/docs/tutoring_docs/videos"
...
TABLE_NAME = "reclamation"  # table unique
